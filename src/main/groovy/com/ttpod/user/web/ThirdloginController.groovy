...
class ThirdloginController extends BaseController {
    ...
    private final static Map<String, String> QQ_APP_ID_KEYS = ["${ANDROID_QQ_APP_ID}": ANDROID_QQ_APP_KEY, "${IOS_QQ_APP_ID}": IOS_QQ_APP_KEY]
    ...
    private qq_login(HttpServletRequest req, HttpServletResponse response, String app_id, String app_key) {
        ...
        logger.debug("qq login openid: {},unionid is {}", openId, unionid)
